...
logros = Logro.create ([{ nombre: 'Gran Tipo' ,  min:2 ,max:5, imagen: 'https://upload.wikimedia.org/wikipedia/en/5/57/Great_Guy_FilmPoster.jpeg'}])
...
#Se crea el user administrador, que sera el propietario de los favor del blog anterior
User.create! nombre: 'Nancy', apellido: 'Ulises', email: 'ulisesynancy@hotmail.com', password: '123456', password_confirmation: '123456', nacimiento:'1980-04-20', admin: true, telefono: '2217362737', localidad: 'La Plata', created_at: '2016-02-06 14:02:10', puntos:0, updated_at: '2015-02-06 14:02:10', reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2015-02-06 14:02:10", last_sign_in_at: "2015-02-06 14:02:10", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", imagen: 'http://hinnaa.com/wp-content/uploads/2014/08/la-sabiduria-de-la-vieja.-Consejos-de-vieja.jpg'
...
#Se crea el precio por defecto para comprar un punto
 Precio.create precio: 10
