...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { code: @compra.code, precio: @compra.precio, puntos: @compra.puntos, tarjeta: @compra.tarjeta } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { code: @compra.code, precio: @compra.precio, puntos: @compra.puntos, tarjeta: @compra.tarjeta } }
