class PreciosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @precio.save
        format.html { redirect_to @precio, notice: 'Se ha guardado el nuevo precio correctamente.' }
  ...
  def update
    respond_to do |format|
      if @precio.update(precio_params)
        format.html { redirect_to @precio, notice: 'Se ha actualizado el nuevo precio correctamente.' }
  ...
  def destroy
    @precio.destroy
    respond_to do |format|
      format.html { redirect_to precios_url, notice: 'Se ha borrado el precio correctamente.' }
  ...
  private
    ...
    def precio_params
        params.require(:precio).permit(:valor)
    end
end
